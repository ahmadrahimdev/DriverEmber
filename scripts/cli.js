...
const contractABI = require("../artifacts/contracts/Driverember.sol/Driverember.json").abi;

program
    .name("driverember-cli")
    .description("CLI tool for Driverember smart contract")
    .version("1.0.0");
